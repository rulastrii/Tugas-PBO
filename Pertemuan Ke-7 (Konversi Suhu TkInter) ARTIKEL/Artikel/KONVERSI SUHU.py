__author__ = 'Rulastri 220511071 TI22L'
...
input_label = tk.Label(root, text="Enter temperature", background='#808000', foreground="#FFFFFF")
...
result_label1 = tk.Label(root, background='#808000', foreground="#FFFFFF")
result_label1.grid(row=3, columnspan=4)
result_label2 = tk.Label(root, background='#808000', foreground="#FFFFFF")
...
dropdown.config(background='#808000', foreground="#FFFFFF")
dropdown["menu"].config(background='#808000', foreground="#FFFFFF")

# button click
call_convert = partial(call_convert, result_label1, result_label2, numberInput)
result_button = tk.Button(root, text="Convert", command=call_convert, background='#808000', foreground="#FFFFFF")
