...
class FormMahasiswa:
    ...
    def aturKomponen(self):
        ...
        # Label
        Label(mainFrame, text='Data Mahasiswa Universitas Muhammadiyah Cirebon   ').grid(row=15, column=1,
        ...
        Label(mainFrame, text='Jenis Kelamin    :').grid(row=3, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Kode Prodi       :').grid(row=5, column=0,
            sticky=W, padx=5, pady=5)
        ...
        Cbo = ttk.Combobox(mainFrame, width = 16, textvariable = self.txtKodeProdi) 
        Cbo.grid(row=5, column=1, padx=5, pady=5)
        ...
        self.btnCari = Button(mainFrame, text='Cari NIM', command=self.onCari, width=10,  fg= "white", bg="green")
    ...
    def onSimpan(self, event=None):
        ...
        jk = self.txtJK.get()
        kode_prodi = self.txtKodeProdi.get()
...
if __name__ == '__main__':
    root2 = tk.Tk()
    aplikasi = FormMahasiswa(root2, "Aplikasi Data Mahasiswa")
    root2.mainloop() 
